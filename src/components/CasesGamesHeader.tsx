export function CasesGamesHeader () {
  return (
    ...
    <a href="https://www.planmkt.com.br/blog" target="_blank" className="text-xs mt-auto cursor-pointer hover:text-zinc-500 ease-in duration-100 text-[#939598] z-10 uppercase">clique aqui pra ver todo o blog</a>
