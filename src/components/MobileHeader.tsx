export function MobileHeader () {
  return (
    <div className="h-[122px] ml-6 gap-8 w-screen flex z-20 flex-col ">
    ...
    <a href="https://www.planmkt.com.br/blog" target="_blank" className="text-[13px]  cursor-pointer hover:text-zinc-500 ease-in duration-100 text-[#939598] z-50 uppercase">clique aqui pra ver todo o blog</a>
